## POINTER STRUCT METHOD INTERFACE PART 1

clone project ini dengan cara

```
git clone https://github.com/BE-Sirclo/Pointer-Struct-Method-Interface-Part1.git
```
...
buat repository pada github organization kalian denga format: `Pointer-Struct-Method-Interface-Part1`
